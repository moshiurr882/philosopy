...
$post_data= array();
while($philosopy_fp->have_posts()){
    $categories= get_the_category();
    $philosopy_fp->the_post();
    $post_data[]= array(
        'title'=>get_the_title(),
        'date'=>get_the_date(),
                    ...
                    <div class="featured__column featured__column--big">
                        <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[0]['thumbnail'])?>');">
                            ...
                            <div class="entry__content">
                                <span class="entry__category"><a href="<?php the_permalink();?>"><?php echo esc_html( $post_data[0]['cat'])?></a></span>
